"""
Django settings for devpot project.
...
SECRET_KEY = 'django-insecure-pm9&k!)++_5*_^#tq(bmiqz&_yvvtdv3w(=($1-e-ir4p11l5+'
...
WSGI_APPLICATION = 'devpot.wsgi.application'
...
'admin_user': {
    ...
    'toolbar': 'Custom',
    'toolbar_Custom': [
            ['Bold', 'Italic', 'Underline', 'TextColor','Format','Font'],
